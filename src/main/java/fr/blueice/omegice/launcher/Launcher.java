...
import fr.blueice.omegice.launcher.ui.panels.pages.App;
import fr.blueice.omegice.launcher.ui.panels.pages.Login;
...
public class Launcher extends Application {
    ...
    private final Path launcherDir = GameDirGenerator.createGameDir("omegice", true);
    ...
    public Launcher() {
        instance = this;
        this.logger = new Logger("[Omegice]", this.launcherDir.resolve("launcher.log"));
